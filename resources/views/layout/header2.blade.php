...
<head>
  ...
  <!-- Favicon -->
  <link rel="shortcut icon" type="image/icon" href="login/images/favicon-16x16.html"/>

  <!-- Main structure css file -->
  <link  rel="stylesheet" href="login/css/login3-style.css">
								...
								<div class="topheader-navholder-ct">
									...
									<nav id="main-nav">
										<ul class="nav navbar-nav megamenu">
											...
											<li class="dropdown">
												<a href='#'>Địa điểm du lịch<b class="caret"></b></a>
												<div id="dropdown-menu2" class="dropdown-menu">
													<ul>
														@foreach($theloai as $tl)
														<li class="parent dropdown-submenu">
															<a href='page-category-left.html'>{{$tl->Ten}}</a>
