                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-20">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Tin Tức Nổi Bật</h4>
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td> <?php echo $i; ?></td>
                                                <td>{{$tt->TieuDe}}</td>
                                                <td><img src="upload/tintucnoibat/{{$tt->Hinh}}" width="100px" height="70px" alt=""></td>
                                                <td class="center"><i class="mdi mdi-table-edit"></i> <a href="admin/tintucnoibat/sua/{{$tt->id}}" style="
                                                    color: blue;">Cập nhật </a>| <a  href="admin/tintucnoibat/xoa/{{$tt->id}}" style="
                                                color: red;
