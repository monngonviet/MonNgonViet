											...
											<div class="row">
												...
												<div class="col-lg-7 col-md-7">
													<div class="post-content">
														<h4 class="title_block"><a href="tin-tuc/{{$tt->id}}/{{$tt->TieuDeKhongDau}}.html" title="{{$tt->TieuDe}}">{{$tt->TieuDe}}</a></h4>
														<div class="post-meta">
															<!-- <span class="post-tip"><span class="icon icon-folder"></span>Tip &amp; trick</span> -->
                                                            <span style="font-size: 14px;"class="comment"><em class="fa fa-eye"></em> {{$tt->SoLuotXem}} lượt xem</span>
														</div><!-- end post-meta -->
